    ...
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="rounded-3xl bg-purple-950 p-6 text-white">
          <h1 className="text-3xl font-bold">Auto-Remediation Loops</h1>
          <p className="mt-2 text-sm text-purple-100">Failures should trigger log pulling, root-cause summary, patch, retest and retry.</p>
