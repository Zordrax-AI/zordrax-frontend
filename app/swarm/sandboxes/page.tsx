    ...
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="rounded-3xl bg-purple-950 p-6 text-white">
          <h1 className="text-3xl font-bold">Sandboxed Workers</h1>
          <p className="mt-2 text-sm text-purple-100">Every AI task should run in an isolated container workspace.</p>
